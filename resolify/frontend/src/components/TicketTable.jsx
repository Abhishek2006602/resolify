...
function MrrCell({ mrr, paymentStatus, accountHealth }) {
  ...
  if (atRisk) {
    return (
      <span className="text-xs font-medium flex items-center gap-1" style={{ color: '#F85149' }}>
        <span className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: '#F85149' }} />
        ${mrr} at risk
      </span>
    )
  }
  if (trialing) {
    return <span className="text-xs font-medium" style={{ color: '#D29922' }}>${mrr} trial</span>
  }
              ...
              tickets.map(t => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Customer */}
                    <td className="px-3 py-3.5" style={{ maxWidth: 140 }}>
                    ...
                    {/* Time */}
                    <td className="px-3 py-3.5">
                      <span className="text-xs mono tabular-nums" style={{ color: 'var(--text-muted)', fontSize: 11 }}>
